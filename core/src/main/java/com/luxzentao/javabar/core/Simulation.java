...
public class Simulation {
    ...
    public void hireStaff(Staff.Type t) {
        ...
        if (t == Staff.Type.DUTY_MANAGER) {
            if (!s.innUnlocked) {
                log.neg("Duty Manager requires the Inn to be unlocked.");
                return;
            }
    ...
    int earlyClosePenaltyForRemaining(int roundsRemaining) {
        ...
        // Reputation penalty is rounds remaining * 2.5, rounded away from zero (more negative)
        // For negative values, Math.floor() rounds away from zero: -12.5 -> -13.0
