...
public enum PubActivity {
    ...
    FAMILY_LUNCH("Family Lunch", 65, 0.07, 3, +3, 1, -0.06, 0.01, -0.03,
            true, PubIdentity.FAMILY_FRIENDLY, 2, PubUpgrade.KITCHEN_SETUP, 1.1),
    ...
    LIVE_SPORTS_NIGHT("Live Sports Night", 120, 0.16, 5, +1, 8, 0.07, 0.01, 0.00,
            false, PubIdentity.ROWDY, 1, PubUpgrade.TVS, 0.9),
    DARTS_COMPETITION("Darts Competition", 70, 0.10, 3, +1, 4, 0.02, 0.01, 0.00,
            false, PubIdentity.RESPECTABLE, 1, PubUpgrade.DARTS, 1.0),
    POOL_NIGHT("Pool Night", 85, 0.11, 4, +1, 5, 0.03, 0.01, 0.00,
            false, PubIdentity.ROWDY, 1, PubUpgrade.POOL_TABLE, 1.0),
    FOOD_SERVICE_NIGHT("Food Service Night", 95, 0.12, 3, +1, 3, -0.03, 0.02, 0.02,
            false, PubIdentity.FAMILY_FRIENDLY, 1, PubUpgrade.KITCHEN, 1.1),
    THEMED_FOOD_NIGHT("Themed Food Night", 125, 0.15, 4, +2, 5, 0.01, 0.03, 0.03,
            false, PubIdentity.RESPECTABLE, 2, PubUpgrade.NEW_KITCHEN_PLAN, 1.2),
    CHEFS_SPECIAL_NIGHT("Chef's Special Night", 150, 0.17, 4, +3, 6, 0.02, 0.03, 0.04,
            false, PubIdentity.RESPECTABLE, 2, PubUpgrade.KITCHEN_EQUIPMENT, 1.3),
    TASTING_MENU_EVENT("Tasting Menu Event", 180, 0.19, 5, +4, 7, 0.03, 0.04, 0.06,
            false, PubIdentity.RESPECTABLE, 2, PubUpgrade.KITCHEN_EQUIPMENT, 1.4);
